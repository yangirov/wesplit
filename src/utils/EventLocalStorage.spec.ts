...
beforeEach(() => {
  spyOn(localStorage, 'getItem').and.callFake(key => (key in localStore ? localStore[key] : null));

  spyOn(localStorage, 'setItem').and.callFake((key, value) => (localStore[key] = value + ''));
